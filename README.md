...
**Universal ID opens the flood gates with a deluge of [profoundly powerful yet easily implemented _NEW_ use-cases](docs/use_cases.md) for your apps and scripts.**
